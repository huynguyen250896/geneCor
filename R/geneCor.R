...
geneCor = function(cna = NULL, exp1 = NULL, alternative1=c("two.sided","less","greater"), met = NULL, exp2 = NULL, alternative2=c("two.sided","less","greater"))
{
  #library
  library(tidyr)
  library(tidyverse)
